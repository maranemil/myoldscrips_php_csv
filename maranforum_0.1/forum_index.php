	...
	<TABLE border="0" cellpadding="2" cellspacing="2">
		<TR>
			<TD>
				...
				$last = $numer;
				$pevious = 1;
				if($page!=$last){ $j = $page+1; echo "<a href='forum_index.php?page=$j'> <B>next</B> </a>"; }
				while($k<$numer){$k++; echo "<a href='forum_index.php?page=$k'>| $k </a> ";}
				if($page!=$pevious){ $g = $page-1; echo "<a href='forum_index.php?page=$g'> <B>| back</B> </a>"; }
				?>
		</TD>
	</TR>
	</TABLE>
