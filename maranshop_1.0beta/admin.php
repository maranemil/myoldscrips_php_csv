...
if ($_POST['action'] === "insert") {
    if ($_FILES['logo']['name'] != "") {
        ...
        if (stripos($_SERVER['OS'], "win") !== false) {
            $path = "prodimg/";
        } // determin path of image folder
        elseif (stripos($_SERVER['OS'], "linux") !== false) {
    ...
    $fp = fopen("prodtable.db", 'ab'); // write the new product in text DB
