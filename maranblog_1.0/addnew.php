...
$action = $_POST['action'];
if ($action=="yessubmit"){
	if($_POST['passwd']!="hereisyourpassword"){echo "wrong password!"; exit;}  // here you can set your password
...
Title: <input type=text name=title size=70 style="font-size: 11px" value='title_here'><BR><BR>
...
var SmileCode;
var newPost;
var oldPost = document.content.content.value;
...
<a href="javascript:InstaSmilie(':sm<?=$i?>:')" onClick="AddSmile(' :sm<?=$i?>: ');"><img src="emoticons/sm<?=$i?>.gif" style="border: none;" ></a> 
...
<font color='white'>password:</font> <input type='password' name='passwd' style="font-size: 11px"><BR><BR>

<input type='submit' name='submit' value='submit article' style='font-size: 11px;background: #FFFFFF; font-weight:bold'>
