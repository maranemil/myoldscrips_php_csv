        ...
        <td>
            ...
            if ($page !== "") {
                ...
                while ($i < $size) {
                    ...
                    echo " + + + + + + <b> $filese[2] </b><br>
 <div align=justify> ||| $filese[3] ||| </div> 
 <br><b>$filese[4] </b><br>
 <hr  >";
                }

                echo "<div style=\"text-align: center;\">
<a href='forum_replay.php?page=$page&subject=$subject[1]'> | 
<B>+ answer at topic </B></a><a href='forum_index.php'>| <B>+ back to index</B>
 </a>|</div>";
            }
            ?>
        </td>
