...
<TABLE>
	<form action='sendorder.php' method='post'>
		<TR><TD><B>Product name:</B> </TD><TD><input readonly type=text name=prodname value="<?=$_GET['prodname'];?>"><BR></TD></TR>
		<TR><TD><B>Price:</B> </TD><TD><input readonly type=text name=price value="<?=$_GET['price'].$curency;?>"><BR></TD></TR>
